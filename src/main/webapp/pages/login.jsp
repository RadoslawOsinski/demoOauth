...
<body>
    ...
    <form action="<c:url value="/connect/twitter" />" method="POST">
        <p>You haven't created any connections with Twitter yet. Click the button to create
            ...
            <p><button type="submit"><img src="https://help.twitter.com/content/dam/help-twitter/brand/logo.png"/>
        </button></p>
    </form>
...
------------------------------------------
    <br/>
    <p><a href="<c:url value="/auth/twitter"/>"><img src="https://1.bp.blogspot.com/-b_SfXKvo7uQ/WR5lIAr3LFI/AAAAAAAABFk/Y94kiT6-DeM1zb5glYZN9fOt42wMRsmvACLcB/s1600/twitter_login_button.png" border="0"/></a></p>
